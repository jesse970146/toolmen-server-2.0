...
const Errorpage = () => {
  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-center bg-gray-50 px-4 py-8 select-none">
      <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl flex flex-col md:flex-row items-center gap-8 md:gap-16 max-w-5xl transition-all duration-300 hover:shadow-2xl border border-gray-100">
        
        {/* 左側圖片區 - RWD 優化: 手機版縮小，電腦版正常 */}
        <div className="w-64 md:w-96 flex-shrink-0 animate-fade-in-up">
          <img 
            src={dory} 
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          <div className="text-6xl md:text-8xl font-black text-blue-200 mb-2 tracking-wider">
            OOPS!
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center text-lg text-gray-500 gap-2 mb-8 font-medium">
